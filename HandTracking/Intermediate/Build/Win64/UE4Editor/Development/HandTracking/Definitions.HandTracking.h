...
#define UE_PROJECT_NAME HandTracking
#define UE_TARGET_NAME HandTrackingEditor
#define UE_MODULE_NAME "HandTracking"
...
#define HANDTRACKING_API DLLEXPORT
